...
$LANG['Sort menu'] = 'Sort menu';
$LANG['Saving item ... '] = 'Saving item ... ';
$LANG['Click to edit'] = 'Click to edit';
$LANG['Click on the menu items and edit them. Empty will delete'] = 'Click on the menu items and edit them. Empty will delete';
$LANG['Menu has been reset'] = 'Menu has been reset';
